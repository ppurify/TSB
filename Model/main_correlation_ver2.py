...
import make_csv_corrlation as make_csv
import os
import sys
...
def max_main(_grid, _YT_locations, _Job_locations, number_of_YT, number_of_Job, casefolder_path, time, _prev_count, alpha1, alpha2, alpha3, rep):
  ...
  change_second_min_arcs_cost_to_bignumber(arcs_YT_to_Pick, arcs_Pick_to_Drop, arcs_Drop_to_Pick, number_of_YT, number_of_Job, number_of_final_route)
