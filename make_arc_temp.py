...
#         # cost 계산
#         arcs_Pick_to_Drop[i].cost = get_cost(prev_count, now_count, arcs_Pick_to_Drop[i].path, alpha1=0, alpha2=alpha2, alpha3=alpha3)
...
#         # cost 계산
#         arcs_Drop_to_Pick[i].cost = get_cost(prev_count, now_count, arcs_Drop_to_Pick[i].path, alpha1=0, alpha2=alpha2, alpha3=alpha3)
